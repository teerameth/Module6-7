...
class Robot():
    ...
    def readPosition(self):
        ...
        responsePacket = self.serialDevice.read(
            self.serialDevice.inWaiting())  # [0xFF, 0xFF, 3, 0x02, X_high, X_low, Y_high, Y_low, checksum]
        print(responsePacket)
...
def reciever():
    while True:
        ...
        if responsePacket: print(list(responsePacket))
        time.sleep(0.5)
...
if __name__ == "__main__":
    robot = Robot("COM3", 115200, "COM12", 115200)
    robot.connectXY()
